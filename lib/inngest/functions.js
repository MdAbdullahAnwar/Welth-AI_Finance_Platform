...
const getMonthlyStats = async (userId, month) => {
  ...
  return {
    totalIncome: Number(rawStats.totalIncome.toFixed(2)),
    totalExpenses: Number(rawStats.totalExpenses.toFixed(2)),
    transactionCount: rawStats.transactionCount,
    byCategory: Object.fromEntries(
      Object.entries(rawStats.byCategory).map(([key, value]) => [
        key,
